...
const getPage = async () => {
  try {
    let res = await getPageApi(
      ...
      queryRef.value.searchForm.pickStatus=1,
         // title参数
    );
  ...
  <div id="box">
    ...
    <el-table :data="outboundOrderList" style="width: 100%">
      ...
      <el-table-column prop="id" label="商品编码" width="80"/>
       <el-table-column prop="pickStatus" label="ᅟᅠ 状态" width="100">
      ...
      <el-table-column prop="outCount" label="待检货数量" width="100"/>
      <el-table-column prop="pickingCount" label="已拣货数量" width="100"/>
      ...
      <el-table-column label="操作" width="100" fixed="right">
        <template #default="scope">
          <el-button type="success"  @click="handleView(scope.row)">拣货</el-button>
        </template>
      </el-table-column>
    </el-table>
